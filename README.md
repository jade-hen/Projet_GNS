...
La séparation des rôles des protocoles est fondamentale :
...
Les sessions iBGP sont établies en full‑mesh dans chaque AS opérateur, en utilisant les loopbacks. Ce choix est volontairement pédagogique et garantit que tous les routeurs BGP d’un même AS partagent exactement les mêmes informations.
...
1.  Il reconstruit la topologie complète du réseau.
2.  Pour chaque routeur, il génère :
...
1.  Il écrit un fichier de configuration Cisco complet par routeur.
